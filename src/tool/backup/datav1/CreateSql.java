...
public class CreateSql implements TableDataOpt {
    ...
    * @throws IOException
    ...
    private List<String> getSelectSqlList(String tableName, List<String> primaryKeyList, List<String> columnList,
    ...
    private List<String> getInserSqlList(String tableName, List<String> columnList,
            List<List<String>> rowsValueList) {
        List<String> sqlList = new ArrayList<String>();
        for (List<String> valueList : rowsValueList) {
            padData(columnList, valueList);
    ...
    private List<String> getUpdateSqlList(String tableName, List<String> primaryKeyList, List<String> columnList,
            List<List<String>> rowsValueList) {
        if (primaryKeyList.isEmpty()) {
            return null;
        }
    ...
    private List<String> getDeteleSqlList(String tableName, List<String> primaryKeyList, List<String> columnList,
            List<List<String>> rowsValueList) {
        if (primaryKeyList.isEmpty()) {
            return null;
        }
...
//            columnList.add(table.get(COLUMN_NAME_ROW_NO, i));
    ...
    private void writeFile(String filePath, List<String> valueList) {
